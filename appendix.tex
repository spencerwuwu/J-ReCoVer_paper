...
In a commutativity analysis, J-ReCoVer first tries to compile the example then perform commutativity analysis. If the analysis can not conclude that the example is commutative, J-ReCoVer then runs 500 randomly generated test cases to try to find a counterexample. If the test cases all pass, then the result will be "unknown".

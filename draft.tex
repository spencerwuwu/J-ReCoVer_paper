...
removed those that could not be compiled, those that were identical to each
other, and those with non-numerical data types (e.g., strings). We obtained
...
bytecode to Jimple and perform the program transformations. The time spent in
...
transformations would still be needed, and our SMT-based back-end verifier (the
...
a program can be handled by more sophisticated program transformations. For

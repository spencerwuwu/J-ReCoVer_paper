...
% Optimization table
Number of (variable):(if-else):(line)=5:1:50. Each number test 60 times.
\begin{table}
	\begin{tabular}{|l|l|l|l|l|l|l|}
\hline
...
% BMC table
Number of (variable):(if-else):(line)=5:1:50. Each number test 20 times.
\begin{table}
	\begin{tabular}{|l|l|l|l|l|l|l|l|}
\hline
		& \multicolumn{3}{c|}{\small BMC}	& & \multicolumn{3}{c|}{\small J-ReCoVer} \\
\hline
